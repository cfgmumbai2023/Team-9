...
function Home(props){
    ...
    return (
        <div className="page-inner head">
            <h1 className="main-head"><b>Urmi Foundation</b></h1>
            <p className="text-secondary">A platform to analyse differently abled students' data to help Automobile Industry in making informed decisions.</p>
            <h4 className="secondary-head">Features:</h4>
            <ul className='main-list' style={{maxWidth: 400}}>
                <li className="list-item">Generate charts based on the students' records.</li>
            ...
            <div onClick={() => navigate('/auto-reports')} className="homeButton">Auto Generated Reports</div>
